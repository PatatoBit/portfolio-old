        ...
        <div className="window">
          <div className="w-full flex top bg-slate-500 shadow-sm">
            ...
            <div className="flex flex-1 p-2 items-center">
              <h1 className="text-4xl text-white poppins">
                patato.live{" "}
                <span className="text-base text-gray-400">v.0.3.1</span>
              </h1>
            </div>
          ...
          <div className="flex flex-col sm:flex-row bottom">
            ...
            <div className="section sm:flex-col top">
              <Link href="/">
                <button className="nav hover:bg-red-500">Home</button>
              </Link>
              <Link href="/about">
                <button className="nav hover:bg-yellow-500">About</button>
              </Link>
              <Link href="/portfolio">
                <button className="nav hover:bg-green-500">Portfolio</button>
              </Link>
              <Link href="/contacts">
                <button className="nav hover:bg-blue-500">Contacts</button>
              </Link>
            </div>
            {/* Content Section */}
